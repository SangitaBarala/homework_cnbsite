...
const CnbTitle = () => {
    return (
        <div className="main-container">
            ...
            <h2 className="cnbSubTitle">"CNB Computers intranet is a place where
                employees can get information about making process development requests, create problem tickets and manage accounts."</h2>
            <div>
